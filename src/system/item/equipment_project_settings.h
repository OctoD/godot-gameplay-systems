#ifndef GGS_EQUIPMENT_SETTINGS_H
#define GGS_EQUIPMENT_SETTINGS_H
...
namespace ggs
{
	class EquipmentProjectSettings : public RefCounted
	{
		GDCLASS(EquipmentProjectSettings, RefCounted);
