...
func _enter_tree():
	add_custom_type(ATTRIBUTE_RESOURCE_NAME, "Resource", attribute_resource, null)
	add_custom_type(ATTRIBUTE_TABLE_RESOURCE_NAME, "Resource", attributes_table_resource, null)
	add_custom_type(ATTRIBUTE_EFFECT_RESOURCE_NAME, "Resource", attribute_effect_resource, null)
	add_custom_type(GAMEPLAY_ATTRIBUTE_MAP_NAME, "Node", gameplay_attribute_map, null)
	add_custom_type(GAMEPLAY_EFFECT_NAME, "Node", gameplay_effect, null)
