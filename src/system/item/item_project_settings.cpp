...
const char *ItemProjectSettings::RESOURCES_PATH_KEY = "application/gameplay_systems/item_system/item_pools_paths";

void ItemProjectSettings::_bind_methods()
{
}

void ItemProjectSettings::add_resource(const String &p_file_path)
{
...
void ItemProjectSettings::remove_resource(const String &p_file_path)
{
	if (Engine::get_singleton()->is_editor_hint())
	{
		ProjectSettings *project_settings = ProjectSettings::get_singleton();
...
PackedStringArray ItemProjectSettings::get_resource_file_paths()
{
...
void ItemProjectSettings::setup()
{
	if (Engine::get_singleton()->is_editor_hint())
	{
		ProjectSettings *project_settings = ProjectSettings::get_singleton();
