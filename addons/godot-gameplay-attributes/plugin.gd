...
const attribute_spec_script = preload("res://addons/godot-gameplay-attributes/objects/attribute_spec.gd")
const ability_container_resource = preload("res://addons/godot-gameplay-attributes/nodes/ability_container.gd")
const activation_event_script = preload("res://addons/godot-gameplay-attributes/objects/activation_event.gd")
...
func _enter_tree():
	...
	add_custom_type(ATTRIBUTE_RESOURCE_NAME, "Resource", attribute_resource, preload("res://addons/godot-gameplay-attributes/assets/Attribute.svg"))
	add_custom_type(ATTRIBUTE_TABLE_RESOURCE_NAME, "Resource", attributes_table_resource, preload("res://addons/godot-gameplay-attributes/assets/AttributeTable.svg"))
	add_custom_type(ATTRIBUTE_EFFECT_RESOURCE_NAME, "Resource", attribute_effect_resource, preload("res://addons/godot-gameplay-attributes/assets/GameplayEffect.svg"))
	add_custom_type(ATTRIBUTE_EFFECT_CONDITION_RESOURCE_NAME, "Resource", attribute_effect_condition_resource, null)
	add_custom_type(GAMEPLAY_ATTRIBUTE_MAP_NAME, "Node", gameplay_attribute_map, preload("res://addons/godot-gameplay-attributes/assets/GameplayAttributeMap.svg"))
	add_custom_type(GAMEPLAY_EFFECT_NAME, "Node", gameplay_effect, preload("res://addons/godot-gameplay-attributes/assets/GameplayEffect.svg"))
	...
	add_custom_type(ABILITY_CONTAINER_NAME, "Node",	ability_container_resource, preload("res://addons/godot-gameplay-attributes/assets/AbilityContainer.svg"))
